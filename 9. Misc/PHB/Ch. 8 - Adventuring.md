...
**_Track._** A character can follow the tracks of another creature, making a Wisdom ([[Survival]]) check when the DM calls for it. (The [[Dungeon Master’s Guide]] has rules for [[tracking]].)
