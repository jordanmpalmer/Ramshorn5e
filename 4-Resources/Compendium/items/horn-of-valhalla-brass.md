...
A brass horn summons `dice: 3d4 + 3|avg` (`3d4 + 3`) [berserkers](4-Resources/Compendium/bestiary/humanoid/berserker.md). To use the brass horn, you must be proficient with all simple weapons.
