...
This vibrant purple prism stores spells cast into it, holding them until you use them. The stone can store up to 3 levels worth of spells at a time. When found, it contains `dice: 1d4 - 1|avg` (`1d4 - 1`) levels of stored spells chosen by the DM.
