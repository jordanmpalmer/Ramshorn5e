...
![](4-Resources/Compendium/books/players-handbook/img/ch5.webp#center)
...
![](4-Resources/Compendium/books/players-handbook/img/c51.webp#center)
...
|-------|------|------------------|----------|---------|--------|
| *Light Armor* |  |  |  |  |  |
| [Padded](4-Resources/Compendium/items/padded-armor.md) | 5 gp | 11 + Dex modifier | — | Disadvantage | 8 lb. |
| [Leather](4-Resources/Compendium/items/leather-armor.md) | 10 gp | 11 + Dex modifier | — | — | 10 lb. |
| [Studded leather](4-Resources/Compendium/items/studded-leather-armor.md) | 45 gp | 12 + Dex modifier | — | — | 13 lb. |
| *Medium Armor* |  |  |  |  |  |
| [Hide](4-Resources/Compendium/items/hide-armor.md) | 10 gp | 12 + Dex modifier (max 2) | — | — | 12 lb. |
| [Chain shirt](4-Resources/Compendium/items/chain-shirt.md) | 50 gp | 13 + Dex modifier (max 2) | — | — | 20 lb. |
| [Scale mail](4-Resources/Compendium/items/scale-mail.md) | 50 gp | 14 + Dex modifier (max 2) | — | Disadvantage | 45 lb. |
| [Breastplate](4-Resources/Compendium/items/breastplate.md) | 400 gp | 14 + Dex modifier (max 2) | — | — | 20 lb. |
| [Half plate](4-Resources/Compendium/items/half-plate-armor.md) | 750 gp | 15 + Dex modifier (max 2) | — | Disadvantage | 40 lb. |
| *Heavy Armor* |  |  |  |  |  |
| [Ring mail](4-Resources/Compendium/items/ring-mail.md) | 30 gp | 14 | — | Disadvantage | 40 lb. |
| [Chain mail](4-Resources/Compendium/items/chain-mail.md) | 75 gp | 16 | Str 13 | Disadvantage | 55 lb. |
| [Splint](4-Resources/Compendium/items/splint-armor.md) | 200 gp | 17 | Str 15 | Disadvantage | 60 lb. |
| [Plate](4-Resources/Compendium/items/plate-armor.md) | 1,500 gp | 18 | Str 15 | Disadvantage | 65 lb. |
| *Shield* |  |  |  |  |  |
| [Shield](4-Resources/Compendium/items/shield.md) | 10 gp | +2 | — | — | 6 lb. |
^armor
...
![](4-Resources/Compendium/books/players-handbook/img/c52.webp#center)
...
If the Armor table shows "Disadvantage" in the Stealth column, the wearer has disadvantage on Dexterity ([Stealth](4-Resources/Compendium/rules/skills.md#Stealth)) checks.
...
![Weapons](4-Resources/Compendium/tables/weapons.md)
...
![](4-Resources/Compendium/books/players-handbook/img/c56.webp#center)
...
> [!gallery]
> ![](4-Resources/Compendium/books/players-handbook/img/c53.webp#gallery)
> ![](4-Resources/Compendium/books/players-handbook/img/c54.webp#gallery)
...
![](4-Resources/Compendium/books/players-handbook/img/c55.webp#center)

## Adventuring Gear

This section describes items that have special rules or require further explanation.

![Adventuring Gear](4-Resources/Compendium/tables/adventuring-gear.md)
...
This kit is a leather pouch containing bandages, salves, and splints. The kit has ten uses. As an action, you can expend one use of the kit to stabilize a creature that has 0 hit points, without needing to make a Wisdom ([Medicine](4-Resources/Compendium/rules/skills.md#Medicine)) check.

![](4-Resources/Compendium/books/players-handbook/img/c57.webp#center)
...
A key is provided with the lock. Without the key, a creature proficient with [thieves' tools](4-Resources/Compendium/items/thieves-tools.md) can pick this lock with a successful DC 15 Dexterity check. Your DM may decide that better locks are available for higher prices.
...
These metal restraints can bind a Small or Medium creature. Escaping the manacles requires a successful DC 20 Dexterity check. Breaking them requires a successful DC 20 Strength check. Each set of manacles comes with one key. Without the key, a creature proficient with [thieves' tools](4-Resources/Compendium/items/thieves-tools.md) can pick the manacles' lock with a successful DC 15 Dexterity check. Manacles have 15 hit points.
...
![](4-Resources/Compendium/books/players-handbook/img/c58.webp#center)
...
This set of instruments is used for navigation at sea. Proficiency with [navigator's tools](4-Resources/Compendium/items/navigators-tools.md) lets you chart a ship's course and follow navigation charts. In addition, these tools allow you to add your proficiency bonus to any ability check you make to avoid getting lost at sea.

### Poisoner's Kit

A [poisoner's kit](4-Resources/Compendium/items/poisoners-kit.md) includes the vials, chemicals, and other equipment necessary for the creation of poisons. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to craft or use poisons.

### Thieves' Tools

This set of tools includes a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers. Proficiency with these tools lets you add your proficiency bonus to any ability checks you make to disarm traps or open locks.

![](4-Resources/Compendium/books/players-handbook/img/c59.webp#center)
...
A [military saddle](4-Resources/Compendium/items/military-saddle.md) braces the rider, helping you keep your seat on an active mount in battle. It gives you advantage on any check you make to remain mounted. An [exotic saddle](4-Resources/Compendium/items/exotic-saddle.md) is required for riding any aquatic or flying mount.
...
![](4-Resources/Compendium/books/players-handbook/img/c510.webp#center)
...
![](4-Resources/Compendium/books/players-handbook/img/c511.webp#center)
...
![Trade Goods](4-Resources/Compendium/tables/trade-goods.md)
...
![](4-Resources/Compendium/books/players-handbook/img/c512.webp#center)

![Lifestyle Expenses](4-Resources/Compendium/tables/lifestyle-expenses.md)
...
![Food, Drink, and Lodging](4-Resources/Compendium/tables/food-drink-and-lodging.md)
...
Some of the most basic types of hirelings appear on the Services table. Other common hirelings include any of the wide variety of people who inhabit a typical town or city, when the adventurers pay them to perform a specific task. For example, a wizard might pay a carpenter to construct an elaborate chest (and its miniature replica) for use in the [Leomund's secret chest](4-Resources/Compendium/spells/leomunds-secret-chest.md) spell. A fighter might commission a blacksmith to forge a special sword. A bard might pay a tailor to make exquisite clothing for an upcoming performance in front of the duke.
...
![](4-Resources/Compendium/books/players-handbook/img/c513.webp#center)

![Services](4-Resources/Compendium/tables/services.md)

### Spellcasting Services

People who are able to cast spells don't fall into the category of ordinary hirelings. It might be possible to find someone willing to cast a spell in exchange for coin or favors, but it is rarely easy and no established pay rates exist. As a rule, the higher the level of the desired spell, the harder it is to find someone who can cast it and the more it costs.

Hiring someone to cast a relatively common spell of 1st or 2nd level, such as [cure wounds](4-Resources/Compendium/spells/cure-wounds.md) or [identify](4-Resources/Compendium/spells/identify.md), is easy enough in a city or town, and might cost 10 to 50 gold pieces (plus the cost of any expensive material components). Finding someone able and willing to cast a higher-level spell might involve traveling to a large city, perhaps one with a university or prominent temple. Once found, the spellcaster might ask for a service instead of payment—the kind of service that only adventurers can provide, such as retrieving a rare item from a dangerous locale or traversing a monster infested wilderness to deliver something important to a distant settlement.

## Trinkets

When you make your character, you can roll once on the [Trinkets](4-Resources/Compendium/items/trinket.md) table to gain a trinket, a simple item lightly touched by mystery. The DM might also use this table. It can help stock a room in a dungeon or fill a creature's pockets.

![](4-Resources/Compendium/books/players-handbook/img/c514.webp#center)