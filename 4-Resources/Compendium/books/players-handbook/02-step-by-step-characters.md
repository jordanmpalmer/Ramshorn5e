...
![](4-Resources/Compendium/books/players-handbook/img/ch1.webp#center)
...
![Bruenor](4-Resources/Compendium/books/players-handbook/img/01-001-bruenor.webp#center)
...
- For attacks with **melee weapons**, use your Strength modifier for attack and damage rolls. A weapon that has the finesse property, such as a [rapier](4-Resources/Compendium/items/rapier.md), can use your Dexterity modifier instead.  
- For attacks with **ranged weapons**, use your Dexterity modifier for attack and damage rolls. A melee weapon that has the thrown property, such as a [handaxe](4-Resources/Compendium/items/handaxe.md), can use your Strength modifier instead.  
...
![](4-Resources/Compendium/books/players-handbook/img/c0-03.webp#center)
...
**In the second tier (levels 5-10),** characters come into their own. Many spellcasters gain access to 3rd-level spells at the start of this tier, crossing a new threshold of magical power with spells such as [fireball](4-Resources/Compendium/spells/fireball.md) and [lightning bolt](4-Resources/Compendium/spells/lightning-bolt.md). At this tier, many weapon-using classes gain the ability to make multiple attacks in one round. These characters have become important, facing dangers that threaten cities and kingdoms.
