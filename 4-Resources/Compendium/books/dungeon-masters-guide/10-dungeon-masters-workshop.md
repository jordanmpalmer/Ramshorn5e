...
![Proficiency Dice](4-Resources/Compendium/tables/proficiency-dice.md)
...
![Ability Check Proficiency by Class](4-Resources/Compendium/tables/ability-check-proficiency-by-class.md)
...
Consider using the New Ability Scores: Honor and Sanity||Sanity score from  if your campaign revolves around entities of an utterly alien and unspeakable nature, such as Great Cthulhu, whose powers and minions can shatter a character's mind.
...
When adventurers confront threats they have no hope of overcoming, you can call for them to make a Wisdom saving throw. Set the DC according to the circumstances. A character who fails the save becomes [frightened](4-Resources/Compendium/rules/conditions.md#frightened) for 1 minute. The character can repeat the saving throw at the end of each of his or her turns, ending the effect on the character on a successful save.
...
![Explosives](4-Resources/Compendium/tables/explosives.md)
...
![Figuring Out Alien Technology](4-Resources/Compendium/tables/figuring-out-alien-technology.md)
...
![Speed Factor Initiative Modifiers](4-Resources/Compendium/tables/speed-factor-initiative-modifiers.md)
...
- [Climb onto a Bigger Creature](4-Resources/Compendium/rules/actions.md#Climb%20onto%20a%20Bigger%20Creature)  
- [Disarm](4-Resources/Compendium/rules/actions.md#Disarm)  
- [Mark](4-Resources/Compendium/rules/actions.md#Mark)  
- [Overrun](4-Resources/Compendium/rules/actions.md#Overrun)  
- [Shove Aside](4-Resources/Compendium/rules/actions.md#Shove%20Aside)  
- [Tumble](4-Resources/Compendium/rules/actions.md#Tumble)  
...
- The group's leader is reduced to 0 hit points, [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated), taken prisoner, or removed from battle.  
...
If you want a monster to be proficient in a skill, you can give it a bonus equal to its proficiency bonus on ability checks related to that skill. For example, a monster with sharp senses might have a bonus on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception)) checks, while a duplicitous monster might have a bonus on Charisma ([Deception](4-Resources/Compendium/rules/skills.md#Deception)) checks.

You can double the proficiency bonus to account for heightened mastery. For example, a doppelganger is so good at deceiving others that its bonus on Charisma ([Deception](4-Resources/Compendium/rules/skills.md#Deception)) checks is equal to double its proficiency bonus + its Charisma modifier.
...
All monsters have a passive Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception)) score, which is most often used to determine whether a monster detects approaching or hidden enemies. A monster's passive Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception)) score is 10 + its Wisdom modifier. If the monster has proficiency in the Perception skill, its score is 10 + its Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception)) bonus.
...
| Fey Ancestry | [Drow](4-Resources/Compendium/bestiary/humanoid/drow.md) | — |
...
| Regeneration | [Troll](4-Resources/Compendium/bestiary/giant/troll.md) | Increase the monster's effective hit points by 3 × the number of hit points the monster regenerates each round. |
...
| Skeleton | +2 Dex, -4 Int, -4 Cha | Vulnerable to bludgeoning damage, immune to poison damage and [exhaustion](4-Resources/Compendium/rules/conditions.md#exhaustion), can't be poisoned, darkvision 60 ft., can't speak but understands the languages it knew in life |
...
![Spell Damage](4-Resources/Compendium/tables/spell-damage.md)
...
Filling in the remaining details, we end up with the following [racial traits for the aasimar](4-Resources/Compendium/races/aasimar-dmg.md).
...
The Spell Points by Level table applies to [bards](4-Resources/Compendium/classes/bard.md), [clerics](4-Resources/Compendium/classes/cleric.md), [druids](4-Resources/Compendium/classes/druid.md), [sorcerers](4-Resources/Compendium/classes/sorcerer.md), and [wizards](4-Resources/Compendium/classes/wizard.md). For a [paladin](4-Resources/Compendium/classes/paladin.md) or [ranger](4-Resources/Compendium/classes/ranger.md), halve the character's level in that class and then consult the table. For a [fighter (Eldritch Knight)](4-Resources/Compendium/classes/fighter-eldritch-knight.md) or [rogue (Arcane Trickster)](4-Resources/Compendium/classes/rogue-arcane-trickster.md), divide the character's level in that class by three.
