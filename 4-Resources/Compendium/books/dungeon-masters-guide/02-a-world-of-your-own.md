...
![Forms of Government](4-Resources/Compendium/tables/forms-of-government.md)
...
![Examples of Faction Ranks](4-Resources/Compendium/tables/examples-of-faction-ranks.md)
...
![World-Shaking Events](4-Resources/Compendium/tables/world-shaking-events.md)
...
![Cataclysmic Disasters](4-Resources/Compendium/tables/cataclysmic-disasters.md)
...
![Extinction or Depletion](4-Resources/Compendium/tables/extinction-or-depletion.md)
...
![New Organizations](4-Resources/Compendium/tables/new-organizations.md)
...
Dedicated spellcasters learn 3rd-level spells at the start of this tier. Suddenly characters can fly, damage large numbers of foes with [fireball](4-Resources/Compendium/spells/fireball.md) and [lightning bolt](4-Resources/Compendium/spells/lightning-bolt.md) spells, and even breathe underwater. They master 5th-level spells by the end of the tier, and spells such as [teleportation circle](4-Resources/Compendium/spells/teleportation-circle.md), [scrying](4-Resources/Compendium/spells/scrying.md), [flame strike](4-Resources/Compendium/spells/flame-strike.md), [legend lore](4-Resources/Compendium/spells/legend-lore.md), and [raise dead](4-Resources/Compendium/spells/raise-dead.md) can have a significant impact on their adventures. They start acquiring more permanent magic items (uncommon and rare ones) as well, which will serve them for the rest of their careers.
...
Dedicated spellcasters gain access to 6th-level spells at 11th level, including spells that completely change the way adventurers interact with the world. Their big, flashy spells are significant in combat-[disintegrate](4-Resources/Compendium/spells/disintegrate.md), [blade barrier](4-Resources/Compendium/spells/blade-barrier.md), and [heal](4-Resources/Compendium/spells/heal.md), for example-but behind-the-scenes spells such as [word of recall](4-Resources/Compendium/spells/word-of-recall.md), [find the path](4-Resources/Compendium/spells/find-the-path.md), [contingency](4-Resources/Compendium/spells/contingency.md), [teleport](4-Resources/Compendium/spells/teleport.md), and [true seeing](4-Resources/Compendium/spells/true-seeing.md) alter the way players approach their adventures. Each spell level after that point introduces new effects with an equally large impact. The adventurers find rare magic items (and very rare ones) that bestow similarly powerful abilities.
...
Dedicated spellcasters at this tier wield earthshaking 9th-level spells such as [wish](4-Resources/Compendium/spells/wish.md), [gate](4-Resources/Compendium/spells/gate.md), [storm of vengeance](4-Resources/Compendium/spells/storm-of-vengeance.md), and [astral projection](4-Resources/Compendium/spells/astral-projection.md). Characters have several rare and very rare magic items at their disposal, and begin discovering legendary items such as a [vorpal sword](4-Resources/Compendium/items/vorpal-sword.md) or a [staff of the magi](4-Resources/Compendium/items/staff-of-the-magi.md).
...
![Wuxia Weapon Names](4-Resources/Compendium/tables/wuxia-weapon-names.md)
