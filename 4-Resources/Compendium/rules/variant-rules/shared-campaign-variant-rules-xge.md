...
Characters can use their monetary treasure to purchase anything from the equipment lists in chapter 5 of the "Player's Handbook". In addition, the Adventurers League allows characters to purchase potions and spell scrolls, as detailed below. A [spell scroll](4-Resources/Compendium/items/spell-scroll.md) can be purchased only by a character who is capable of casting the spell in question.

![Potions for Sale](4-Resources/Compendium/tables/potions-for-sale-xge.md)

![Spell Scrolls for Sale](4-Resources/Compendium/tables/spell-scrolls-for-sale-xge.md)
