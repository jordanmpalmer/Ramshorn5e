...
- **Skill Proficiencies.** [Insight](4-Resources/Compendium/rules/skills.md#Insight), [Persuasion](4-Resources/Compendium/rules/skills.md#Persuasion)  
- **Tool Proficiencies.** One type of artisan's tools, or [navigator's tools](4-Resources/Compendium/items/navigators-tools.md), or an additional language  
- **Languages.** One of your choice  
- **Equipment.** A set of artisan's tools (one of your choice) or a [mule](4-Resources/Compendium/items/mule.md) and [cart](4-Resources/Compendium/items/cart.md), a letter of introduction from your guild, a set of [traveler's clothes](4-Resources/Compendium/items/travelers-clothes.md), and a belt [pouch](4-Resources/Compendium/items/pouch.md) containing 15 gp  
