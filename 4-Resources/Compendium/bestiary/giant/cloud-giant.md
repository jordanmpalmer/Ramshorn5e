...
- "desc": "The giant's innate spellcasting ability is Charisma. It can innately cast\
    ...
    \ magic](4-Resources/Compendium/spells/detect-magic.md), [fog cloud](4-Resources/Compendium/spells/fog-cloud.md),\
    \ [light](4-Resources/Compendium/spells/light.md)\n\n1/day each: [control\
    \ weather](4-Resources/Compendium/spells/control-weather.md), [gaseous form](4-Resources/Compendium/spells/gaseous-form.md)\n\
    \n3/day each: [feather fall](4-Resources/Compendium/spells/feather-fall.md),\
    \ [fly](4-Resources/Compendium/spells/fly.md), [misty step](4-Resources/Compendium/spells/misty-step.md),\
    \ [telekinesis](4-Resources/Compendium/spells/telekinesis.md)"
  "name": "innate"
- "desc": "The giant has advantage on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
...
- "JttRC"
- "SatO"
"image": "4-Resources/Compendium/bestiary/giant/token/cloud-giant.png"
```
^statblock
