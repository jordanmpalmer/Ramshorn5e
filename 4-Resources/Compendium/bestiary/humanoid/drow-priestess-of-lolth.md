...
- "desc": "The drow's spellcasting ability is Charisma (spell save DC 15). She can\
    ...
    \ fire](4-Resources/Compendium/spells/faerie-fire.md), [levitate](4-Resources/Compendium/spells/levitate.md)\
    \ (self only)"
  "name": "innate"
- "desc": "The drow is a 10th-level spellcaster. Her spellcasting ability is Wisdom\
    ...
    \ following cleric spells prepared:\n\nCantrips (at will): [guidance](4-Resources/Compendium/spells/guidance.md),\
    \ [poison spray](4-Resources/Compendium/spells/poison-spray.md), [resistance](4-Resources/Compendium/spells/resistance.md),\
    ...
    \n1st level (4 slots): [animal friendship](4-Resources/Compendium/spells/animal-friendship.md),\
    \ [cure wounds](4-Resources/Compendium/spells/cure-wounds.md), [detect poison\
    \ and disease](4-Resources/Compendium/spells/detect-poison-and-disease.md), [ray\
    \ of sickness](4-Resources/Compendium/spells/ray-of-sickness.md)\n\n2nd level\
    ...
    \ animals](4-Resources/Compendium/spells/conjure-animals.md) (2 [giant spiders](4-Resources/Compendium/bestiary/beast/giant-spider.md)),\
    \ [dispel magic](4-Resources/Compendium/spells/dispel-magic.md)\n\n4th level\
    \ (3 slots): [divination](4-Resources/Compendium/spells/divination.md), [freedom\
    \ of movement](4-Resources/Compendium/spells/freedom-of-movement.md)\n\n5th\
    \ level (2 slots): [insect plague](4-Resources/Compendium/spells/insect-plague.md),\
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ (5d6) poison damage."
  "name": "Scourge"
- "desc": "The drow attempts to magically summon a [yochlol](4-Resources/Compendium/bestiary/fiend/yochlol.md)\
...
- "WDMM"
- "GoS"
"image": "4-Resources/Compendium/bestiary/humanoid/token/drow-priestess-of-lolth.png"
```
^statblock
