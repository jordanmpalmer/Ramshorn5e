...
- "desc": "Any creature other than a troglodyte that starts its turn within 5 feet\
    \ of the troglodyte must succeed on a DC 12 Constitution saving throw or be [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "desc": "While in sunlight, the troglodyte has disadvantage on attack rolls, as\
    \ well as on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/humanoid/token/troglodyte.png"
```
^statblock
# [Troglodyte](4-Resources/Compendium/bestiary/humanoid/troglodyte.md)
