...
- "desc": "The spy deals an extra dice: 2d6|avg (2d6) damage when it hits a target\
    ...
    \ is within 5 feet of an ally of the spy that isn't [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated)\
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/humanoid/token/spy.png"
```
^statblock
