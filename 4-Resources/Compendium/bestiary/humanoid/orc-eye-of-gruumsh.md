...
- "desc": "The orc is a 3rd-level spellcaster. Its spellcasting ability is Wisdom\
    ...
    \ [resistance](4-Resources/Compendium/spells/resistance.md), [thaumaturgy](4-Resources/Compendium/spells/thaumaturgy.md)\n\
    \n1st level (4 slots): [bless](4-Resources/Compendium/spells/bless.md), [command](4-Resources/Compendium/spells/command.md)\n\
    \n2nd level (2 slots): [augury](4-Resources/Compendium/spells/augury.md),\
    \ [spiritual weapon](4-Resources/Compendium/spells/spiritual-weapon.md) (spear)"
  "name": "spells"
...
- "EGW"
- "IDRotF"
"image": "4-Resources/Compendium/bestiary/humanoid/token/orc-eye-of-gruumsh.png"
```
^statblock
