...
- "desc": "Ranged Weapon Attack: dice: d20+3 (+3 to hit), range 5/15 ft., one\
    \ Large or smaller creature. Hit: The target is [restrained](4-Resources/Compendium/rules/conditions.md#restrained).\
...
- "desc": "When a creature misses the kuo-toa with a melee weapon attack, the kuo-toa\
    ...
    \ [grappled](4-Resources/Compendium/rules/conditions.md#grappled) while the weapon\
...
- "PSI"
- "SatO"
"image": "4-Resources/Compendium/bestiary/humanoid/token/kuo-toa.png"
```
^statblock
