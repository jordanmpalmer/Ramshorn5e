...
- "desc": "The assassin deals an extra dice: 4d6|avg (4d6) damage when it hits\
    ...
    \ the target is within 5 feet of an ally of the assassin that isn't [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated)\
...
- "SatO"
- "ToFW"
"image": "4-Resources/Compendium/bestiary/humanoid/token/assassin.png"
```
^statblock
# [Assassin](4-Resources/Compendium/bestiary/humanoid/assassin.md)
*Source: Monster Manual p. 343, Tasha's Cauldron of Everything. Available in the SRD.*  
