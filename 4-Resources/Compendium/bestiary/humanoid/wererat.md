...
- "desc": "The wererat can use its action to polymorph into a rat-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The wererat has advantage on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/humanoid/token/wererat.png"
```
^statblock
