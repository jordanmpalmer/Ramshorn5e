...
- "desc": "The werewolf can use its action to polymorph into a wolf-humanoid hybrid\
  ...
  "name": "Shapechanger"
- "desc": "The werewolf has advantage on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
...
- "CM"
- "BMT"
"image": "4-Resources/Compendium/bestiary/humanoid/token/werewolf.png"
```
^statblock
