...
- "desc": "The solar's spellcasting ability is Charisma (spell save DC 25). It can\
    ...
    \ will: [detect evil and good](4-Resources/Compendium/spells/detect-evil-and-good.md),\
    \ [invisibility](4-Resources/Compendium/spells/invisibility.md) (self only)\n\n\
    1/day each: [commune](4-Resources/Compendium/spells/commune.md), [control\
    \ weather](4-Resources/Compendium/spells/control-weather.md)\n\n3/day each:\
    \ [blade barrier](4-Resources/Compendium/spells/blade-barrier.md), [dispel evil\
    \ and good](4-Resources/Compendium/spells/dispel-evil-and-good.md), [resurrection](4-Resources/Compendium/spells/resurrection.md)"
  "name": "innate"
...
- "desc": "The solar targets one creature it can see within 30 feet of it. If the\
    ...
    \ or be [blinded](4-Resources/Compendium/rules/conditions.md#blinded) until magic\
    \ such as the [lesser restoration](4-Resources/Compendium/spells/lesser-restoration.md)\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/celestial/token/solar.png"
```
^statblock
