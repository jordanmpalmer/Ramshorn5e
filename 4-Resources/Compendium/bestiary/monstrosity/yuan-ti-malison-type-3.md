...
- "desc": "The yuan-ti's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \nAt will: [animal friendship](4-Resources/Compendium/spells/animal-friendship.md)\
    \ (snakes only)\n\n3/day: [suggestion](4-Resources/Compendium/spells/suggestion.md)"
  "name": "innate"
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
    ...
    \ [grappled](4-Resources/Compendium/rules/conditions.md#grappled) (escape DC 13).\
    \ Until this grapple ends, the target is [restrained](4-Resources/Compendium/rules/conditions.md#restrained),\
...
- "ToA"
- "CM"
"image": "4-Resources/Compendium/bestiary/monstrosity/token/yuan-ti-malison-type-3.png"
```
^statblock
