...
- "desc": "The hydra has five heads. While it has more than one head, the hydra has\
    \ advantage on saving throws against being [blinded](4-Resources/Compendium/rules/conditions.md#blinded),\
    ...
    \ and knocked [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious).\n\
...
- "PaBTSO"
- "SatO"
"image": "4-Resources/Compendium/bestiary/monstrosity/token/hydra.png"
```
^statblock
