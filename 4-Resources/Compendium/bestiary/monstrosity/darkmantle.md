...
"cr": "1/2"
"traits":
- "desc": "The darkmantle can't use its blindsight while [deafened](4-Resources/Compendium/rules/conditions.md#deafened)."
  "name": "Echolocation"
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one creature.\
    ...
    \ and the target is also [blinded](4-Resources/Compendium/rules/conditions.md#blinded)\
...
- "desc": "A 15-foot radius of magical darkness extends out from the darkmantle, moves\
    ...
    \ maintains [concentration](4-Resources/Compendium/rules/conditions.md#concentration),\
...
- "WBtW"
- "KftGV"
"image": "4-Resources/Compendium/bestiary/monstrosity/token/darkmantle.png"
```
^statblock
