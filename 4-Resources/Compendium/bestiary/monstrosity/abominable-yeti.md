...
- "desc": "The yeti has advantage on Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
  ...
  "name": "Keen Smell"
- "desc": "The yeti has advantage on Dexterity ([Stealth](4-Resources/Compendium/rules/skills.md#Stealth))\
...
- "desc": "The yeti targets one creature it can see within 30 feet of it. If the target\
    ...
    \ against this magic or take dice: 6d6|avg (6d6) cold damage and then be [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed)\
...
- "IDRotF"
- "CM"
"image": "4-Resources/Compendium/bestiary/monstrosity/token/abominable-yeti.png"
```
^statblock
