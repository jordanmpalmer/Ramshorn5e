...
- "desc": "Melee Weapon Attack: dice: d20+7 (+7 to hit), reach 50 ft., one creature.\
    \ Hit: The target is [grappled](4-Resources/Compendium/rules/conditions.md#grappled)\
    \ (escape DC 15). Until the grapple ends, the target is [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
  ...
  "name": "Tendril"
- "desc": "The roper pulls each creature [grappled](4-Resources/Compendium/rules/conditions.md#grappled)\
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/monstrosity/token/roper.png"
```
^statblock
