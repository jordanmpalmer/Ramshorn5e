...
- "desc": "Ranged Weapon Attack: dice: d20+7 (+7 to hit), range 150/600 ft., one\
    ...
    \ throw or be [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned).\
    \ The poison lasts until it is removed by the [lesser restoration](4-Resources/Compendium/spells/lesser-restoration.md)\
...
- "KftGV"
- "SatO"
"image": "4-Resources/Compendium/bestiary/fiend/token/erinyes.png"
```
^statblock
...
> 
> Some erinyes carry a [rope of entanglement](4-Resources/Compendium/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.
