...
- "desc": "The barlgura's spellcasting ability is Wisdom (spell save DC 13). The barlgura\
    ...
    1/day each: [entangle](4-Resources/Compendium/spells/entangle.md), [phantasmal\
    \ force](4-Resources/Compendium/spells/phantasmal-force.md)\n\n2/day each:\
    \ [disguise self](4-Resources/Compendium/spells/disguise-self.md), [invisibility](4-Resources/Compendium/spells/invisibility.md)\
    \ (self only)"
  "name": "innate"
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/fiend/token/barlgura.png"
```
^statblock
