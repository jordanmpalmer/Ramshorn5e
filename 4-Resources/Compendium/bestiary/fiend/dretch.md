...
- "desc": "A 10-foot radius of disgusting green gas extends out from the dretch. The\
    ...
    \ in that area must succeed on a DC 11 Constitution saving throw or be [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/fiend/token/dretch.png"
```
^statblock
