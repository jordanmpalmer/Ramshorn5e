...
- "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    ...
    \ poison damage and become [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success."
  "name": "Claw (Bite in Beast Form)"
- "desc": "One creature of the quasit's choice within 20 feet of it must succeed on\
    \ a DC 10 Wisdom saving throw or be [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, with disadvantage if the quasit is within line of sight, ending the effect\
    \ on itself on a success."
  "name": "Scare (1/Day)"
- "desc": "The quasit magically turns [invisible](4-Resources/Compendium/rules/conditions.md#invisible)\
    \ until it attacks or uses Scare, or until its [concentration](4-Resources/Compendium/rules/conditions.md#concentration)\
...
- "PSI"
- "PaBTSO"
"image": "4-Resources/Compendium/bestiary/fiend/token/quasit.png"
```
^statblock
# [Quasit](4-Resources/Compendium/bestiary/fiend/quasit.md)
*Source: Monster Manual p. 63, Tasha's Cauldron of Everything. Available in the SRD.*  
