...
- "desc": "The chasme produces a horrid droning sound to which demons are immune.\
    ...
    \ on a DC 12 Constitution saving throw or fall [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious)\
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one creature.\
    ...
    \ by a spell like  [greater restoration](4-Resources/Compendium/spells/greater-restoration.md)."
  "name": "Proboscis"
"source":
- "MM"
- "WDMM"
...
- "CRCotN"
- "KftGV"
"image": "4-Resources/Compendium/bestiary/fiend/token/chasme.png"
```
^statblock
