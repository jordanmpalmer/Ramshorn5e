...
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 10 ft., one target.\
  ...
  "name": "Claw"
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 10 ft., one target.\
    \ Hit: dice: 2d8 + 4|avg (2d8 + 4) piercing damage plus dice: 5d6|avg\
    \ (5d6) poison damage, and the target must succeed on a DC 14 Constitution saving\
    \ throw or become [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "DSotDQ"
- "SatO"
"image": "4-Resources/Compendium/bestiary/fiend/token/bone-devil.png"
```
^statblock
