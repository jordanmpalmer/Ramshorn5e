...
- "desc": "The pit fiend's spellcasting ability is Charisma (spell save DC 21). The\
    ...
    \nAt will: [detect magic](4-Resources/Compendium/spells/detect-magic.md),\
    \ [fireball](4-Resources/Compendium/spells/fireball.md)\n\n3/day each: [hold\
    \ monster](4-Resources/Compendium/spells/hold-monster.md), [wall of fire](4-Resources/Compendium/spells/wall-of-fire.md)"
  "name": "innate"
- "desc": "Any creature hostile to the pit fiend that starts its turn within 20 feet\
    ...
    \ is [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated).\
    \ On a failed save, the creature is [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: dice: d20+14 (+14 to hit), reach 5 ft., one target.\
    ...
    \ on a DC 21 Constitution saving throw or become [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned).\
    \ While [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned) in this\
    \ way, the target can't regain hit points, and it takes dice: 6d6|avg (6d6)\
    \ poison damage at the start of each of its turns. The [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "SatO"
- "ToFW"
"image": "4-Resources/Compendium/bestiary/fiend/token/pit-fiend.png"
```
^statblock
...
> 
> Though devils all have common names, every devil above a lemure in station also has a true name that it keeps secret. A devil can be forced to disclose its true name if [charmed](4-Resources/Compendium/rules/conditions.md#charmed), and ancient scrolls and tomes are said to exist that list the true names of certain devils.
> 
