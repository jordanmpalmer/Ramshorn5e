...
- "desc": "The fiend ignores the range restriction on its telepathy when communicating\
    \ with a creature it has [charmed](4-Resources/Compendium/rules/conditions.md#charmed).\
...
- "desc": "One humanoid the fiend can see within 30 feet of it must succeed on a DC\
    \ 15 Wisdom saving throw or be magically [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ for 1 day. The [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    ...
    \ the next 24 hours.\n\nThe fiend can have only one target [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ at a time. If it charms another, the effect on the previous target ends."
  "name": "Charm"
- "desc": "The fiend kisses a creature [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/fiend/token/succubus.png"
```
^statblock
...
The succubus or incubus resorts to charming a victim magically only when necessary, usually as a form of self-defense. A [charmed](4-Resources/Compendium/rules/conditions.md#charmed) creature isn't responsible for its actions, so forcing it to behave against its will won't bring the fiend closer to the ultimate prize: the victim's soul.
...
Succubi and incubi can reproduce with one another to spawn more of their kind. Less commonly, a succubus or incubus reproduces with a humanoid. From this unholy union, a [cambion](4-Resources/Compendium/bestiary/fiend/cambion.md) child is conceived. Invariably, the fiendish offspring is as wicked as its fiendish parent.
