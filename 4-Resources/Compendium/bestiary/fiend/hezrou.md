...
- "desc": "Any creature that starts its turn within 10 feet of the hezrou must succeed\
    \ on a DC 14 Constitution saving throw or be [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "CRCotN"
- "BMT"
"image": "4-Resources/Compendium/bestiary/fiend/token/hezrou.png"
```
^statblock
