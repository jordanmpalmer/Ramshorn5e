...
- "desc": "The ultroloth's innate spellcasting ability is Charisma (spell save DC\
    ...
    \ components:\n\nAt will: [alter self](4-Resources/Compendium/spells/alter-self.md),\
    \ [clairvoyance](4-Resources/Compendium/spells/clairvoyance.md), [darkness](4-Resources/Compendium/spells/darkness.md),\
    \ [detect magic](4-Resources/Compendium/spells/detect-magic.md), [detect thoughts](4-Resources/Compendium/spells/detect-thoughts.md),\
    \ [dispel magic](4-Resources/Compendium/spells/dispel-magic.md), [invisibility](4-Resources/Compendium/spells/invisibility.md)\
    \ (self only), [suggestion](4-Resources/Compendium/spells/suggestion.md)\n\n1/day\
    \ each: [fire storm](4-Resources/Compendium/spells/fire-storm.md), [mass suggestion](4-Resources/Compendium/spells/mass-suggestion.md)\n\
    \n3/day each: [dimension door](4-Resources/Compendium/spells/dimension-door.md),\
    \ [fear](4-Resources/Compendium/spells/fear.md), [wall of fire](4-Resources/Compendium/spells/wall-of-fire.md)"
  "name": "innate"
...
- "desc": "The ultroloth's eyes sparkle with opalescent light as it targets one creature\
    ...
    \ must succeed on a DC 17 Wisdom saving throw against this magic or be [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ until the end of the ultroloth's next turn. The [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ target is [stunned](4-Resources/Compendium/rules/conditions.md#stunned). If\
    \ the target's saving throw is successful, the target is immune to the ultroloth's\
...
- "EGW"
- "JttRC"
"image": "4-Resources/Compendium/bestiary/fiend/token/ultroloth.png"
```
^statblock
