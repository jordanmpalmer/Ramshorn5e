...
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 10 ft., one target.\
    \ Hit: dice: 2d6 + 4|avg (2d6 + 4) slashing damage. The target is [grappled](4-Resources/Compendium/rules/conditions.md#grappled)\
    \ (escape DC 14) if the devil isn't already grappling a creature. Until this grapple\
    \ ends, the target is [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
...
- "desc": "Up to four chains the devil can see within 60 feet of it magically sprout\
    ...
    \ [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated) or\
    \ dies."
...
- "desc": "When a creature the devil can see starts its turn within 30 feet of the\
    ...
    \ must succeed on a DC 14 Wisdom saving throw or be [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "PaBTSO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/fiend/token/chain-devil.png"
```
^statblock
