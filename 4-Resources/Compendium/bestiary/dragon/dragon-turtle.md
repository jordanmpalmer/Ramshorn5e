...
- "desc": "Melee Weapon Attack: dice: d20+13 (+13 to hit), reach 15 ft., one target.\
    ...
    \ to 10 feet away from the dragon turtle and knocked [prone](4-Resources/Compendium/rules/conditions.md#prone)."
  "name": "Tail"
- "desc": "The dragon turtle exhales scalding steam in a 60-foot cone. Each creature\
    \ in that area must make a DC 18 Constitution saving throw, taking dice: 15d6|avg\
...
- "CM"
- "JttRC"
"image": "4-Resources/Compendium/bestiary/dragon/token/dragon-turtle.png"
```
^statblock
