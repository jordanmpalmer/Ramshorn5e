...
- "desc": "The dragon's innate spellcasting ability is Charisma (spell save DC 13).\
    ...
    \ [minor illusion](4-Resources/Compendium/spells/minor-illusion.md), [mirror image](4-Resources/Compendium/spells/mirror-image.md)"
  "name": "innate"
...
"source":
- "MM"
"image": "4-Resources/Compendium/bestiary/dragon/token/faerie-dragon-yellow.png"
```
^statblock
