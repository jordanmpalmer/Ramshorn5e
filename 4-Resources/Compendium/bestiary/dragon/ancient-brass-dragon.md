...
- "desc": "Each creature of the dragon's choice that is within 120 feet of the dragon\
    \ and aware of it must succeed on a DC 18 Wisdom saving throw or become [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "desc": "The dragon uses one of the following breath weapons:\n\n- Fire Breath.\
    ...
    \ in that line must make a DC 21 Dexterity saving throw, taking dice: 16d6|avg\
...
- "CRCotN"
- "JttRC"
"image": "4-Resources/Compendium/bestiary/dragon/token/ancient-brass-dragon.png"
```
^statblock
