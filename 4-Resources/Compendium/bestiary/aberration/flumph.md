...
- "desc": "If the flumph is knocked [prone](4-Resources/Compendium/rules/conditions.md#prone),\
    \ roll a die. On an odd result, the flumph lands upside-down and is [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated).\
    \ At the end of each of its turns, the flumph can make a DC 10 Dexterity saving\
    \ throw, righting itself and ending the [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated)\
...
- "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    ...
    \ on a failure or ending the recurring acid damage on a success. A [lesser restoration](4-Resources/Compendium/spells/lesser-restoration.md)\
...
- "desc": "Each creature in a 15-foot cone originating from the flumph must succeed\
    ...
    \ The coated creature is [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
    \ as long as the stench lasts, and other creatures are [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned)\
...
- "PaBTSO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/flumph.png"
```
^statblock
