...
- "desc": "The mouther babbles incoherently while it can see any creature and isn't\
    \ [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated). Each\
    ...
    \ can't take reactions until the start of its next turn and rolls a dice: d8|avg\
...
- "desc": "Melee Weapon Attack: dice: d20+2 (+2 to hit), reach 5 ft., one creature.\
    ...
    \ it must succeed on a DC 10 Strength saving throw or be knocked [prone](4-Resources/Compendium/rules/conditions.md#prone).\
...
- "desc": "The mouther spits a chemical glob at a point it can see within 15 feet\
    ...
    \ be [blinded](4-Resources/Compendium/rules/conditions.md#blinded) until the end\
...
- "PaBTSO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/gibbering-mouther.png"
```
^statblock
# [Gibbering Mouther](4-Resources/Compendium/bestiary/aberration/gibbering-mouther.md)
*Source: Monster Manual p. 157, Tasha's Cauldron of Everything. Available in the SRD.*  
...
When a gibbering mouther senses prey, its mouths begin to murmur and chatter, each with a different voice: deep or shrill, wailing or ululating, crying out in agony or ecstasy. This cacophonous gibbering overcomes the senses of any creature that hears it, causing most to flee in terror. Others are overcome with madness or stand [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed), fixated on the horrific creature as it oozes forward to consume them.
