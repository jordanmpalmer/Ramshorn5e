...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 14).\
    ...
    \ [detect thoughts](4-Resources/Compendium/spells/detect-thoughts.md), [invisibility](4-Resources/Compendium/spells/invisibility.md)\
    \ (self only), [mage hand](4-Resources/Compendium/spells/mage-hand.md), [major\
    \ image](4-Resources/Compendium/spells/major-image.md)\n\n1/day: [plane shift](4-Resources/Compendium/spells/plane-shift.md)\
    \ (self only)\n\n2/day each: [fear](4-Resources/Compendium/spells/fear.md),\
    \ [fly](4-Resources/Compendium/spells/fly.md), [fireball](4-Resources/Compendium/spells/fireball.md),\
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/gray-slaad.png"
```
^statblock
