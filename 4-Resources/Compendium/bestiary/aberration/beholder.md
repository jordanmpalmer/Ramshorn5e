...
"skillsaves":
  "Perception": !!int "12"
"condition_immunities": "[prone](4-Resources/Compendium/rules/conditions.md#prone)"
"senses": "darkvision 120 ft., passive Perception 22"
"languages": "Deep Speech, Undercommon"
"cr": "13"
"traits":
- "desc": "The beholder's central eye creates an area of antimagic, as in the [antimagic\
    \ field](4-Resources/Compendium/spells/antimagic-field.md) spell, in a 150-foot\
    \ cone. At the start of each of its turns, the beholder decides which way the\
    \ cone faces and whether the cone is active. The area works against the beholder's\
    \ own eye rays."
  "name": "Antimagic Cone"
"actions":
...
- "desc": "The beholder shoots three of the following magical eye rays at random (reroll\
    ...
    \ throw or be [charmed](4-Resources/Compendium/rules/conditions.md#charmed) by\
    \ the beholder for 1 hour, or until the beholder harms the creature.  \n- 2.\
    \ Paralyzing Ray. The targeted creature must succeed on a DC 16 Constitution\
    ...
    \ creature must succeed on a DC 16 Wisdom saving throw or be [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
    \ for 1 minute. The target can repeat the saving throw at the end of each of its\
    \ turns, ending the effect on itself on a success.  \n- 4. Slowing Ray. The\
    ...
    \ to 30 feet in any direction. It is [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
    \ by the ray's telekinetic grip until the start of the beholder's next turn or\
    \ until the beholder is [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated).\
    ...
    \ must succeed on a DC 16 Wisdom saving throw or fall asleep and remain [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious)\
    ...
    \ [restrained](4-Resources/Compendium/rules/conditions.md#restrained). It must\
    \ repeat the saving throw at the end of its next turn. On a success, the effect\
    \ ends. On a failure, the creature is [petrified](4-Resources/Compendium/rules/conditions.md#petrified)\
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/beholder.png"
```
^statblock
...
As alien as their creator, the rooms in a beholder's lair reflect the creature's arrogance. It festoons its chambers with trophies from the battles it has won, including [petrified](4-Resources/Compendium/rules/conditions.md#petrified) adventurers standing frozen in their horrified final moments, pieces of other beholders, and magic items wrested from powerful foes. A beholder judges its own worth by its acquisitions, and it never willingly parts with its treasures.
