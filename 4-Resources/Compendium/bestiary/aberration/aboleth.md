...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 10 ft., one target.\
    ...
    \ the disease can be removed only by [heal](4-Resources/Compendium/spells/heal.md)\
    \ or another disease-curing spell of 6th level or higher. When the creature is\
    \ outside a body of water, it takes dice: 1d12|avg (1d12) acid damage every\
    \ 10 minutes unless moisture is applied to the skin before 10 minutes have passed."
  "name": "Tentacle"
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 10 ft., one target.\
...
- "desc": "The aboleth targets one creature it can see within 30 feet of it. The target\
    \ must succeed on a DC 14 Wisdom saving throw or be magically [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ by the aboleth until the aboleth dies or until it is on a different plane of\
    \ existence from the target. The [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    ...
    \nWhenever the [charmed](4-Resources/Compendium/rules/conditions.md#charmed) target\
  ...
  "name": "Enslave (3/Day)"
"legendary_actions":
- "desc": "The aboleth makes a Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception))\
    \ check."
  "name": "Detect"
- "desc": "The aboleth makes one tail attack."
  "name": "Tail Swipe"
- "desc": "One creature [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ by the aboleth takes dice: 3d6|avg (3d6) psychic damage, and the aboleth\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/aboleth.png"
```
^statblock
