...
- "desc": "The slaad's innate spellcasting ability is Charisma (spell save DC 12).\
    ...
    \ [detect thoughts](4-Resources/Compendium/spells/detect-thoughts.md), [mage hand](4-Resources/Compendium/spells/mage-hand.md)\n\
    \n1/day: [fireball](4-Resources/Compendium/spells/fireball.md)\n\n2/day\
    \ each: [fear](4-Resources/Compendium/spells/fear.md), [invisibility](4-Resources/Compendium/spells/invisibility.md)\
    \ (self only)"
  "name": "innate"
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/aberration/token/green-slaad.png"
```
^statblock
