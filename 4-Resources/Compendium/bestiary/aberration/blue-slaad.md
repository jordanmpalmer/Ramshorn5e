...
- "desc": "Melee Weapon Attack: dice: d20+8 (+8 to hit), reach 5 ft., one target.\
    ...
    \ transforms into a [red slaad](4-Resources/Compendium/bestiary/aberration/red-slaad.md)\
    \ or, if it has the ability to cast spells of 3rd level or higher, a [green slaad](4-Resources/Compendium/bestiary/aberration/green-slaad.md).\
    \ Only a [wish](4-Resources/Compendium/spells/wish.md) spell can reverse the transformation."
  "name": "Claw"
"source":
- "MM"
- "WDMM"
...
- "PaBTSO"
- "SatO"
"image": "4-Resources/Compendium/bestiary/aberration/token/blue-slaad.png"
```
^statblock
