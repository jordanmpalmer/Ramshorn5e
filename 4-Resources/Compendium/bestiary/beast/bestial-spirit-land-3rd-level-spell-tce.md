...
- monster/type/beast
statblock: inline
aliases: ["Bestial Spirit (Land, 3rd-Level Spell)"]
---
```statblock
...
```
^statblock
# [Bestial Spirit (Land, 3rd-Level Spell)](4-Resources/Compendium/bestiary/beast/bestial-spirit-land-3rd-level-spell-tce.md)
