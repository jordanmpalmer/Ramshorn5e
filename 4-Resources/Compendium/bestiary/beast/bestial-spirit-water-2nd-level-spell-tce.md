...
- monster/type/beast
statblock: inline
aliases: ["Bestial Spirit (Water, 2nd-Level Spell)"]
---
```statblock
...
```
^statblock
# [Bestial Spirit (Water, 2nd-Level Spell)](4-Resources/Compendium/bestiary/beast/bestial-spirit-water-2nd-level-spell-tce.md)
