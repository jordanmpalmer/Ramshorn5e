...
- "desc": "Melee Weapon Attack: dice: d20+3 (+3 to hit), reach 0 ft., one target\
    ...
    \ but [poisoned](4-Resources/Compendium/rules/conditions.md#poisoned) for 1 hour,\
    \ even after regaining hit points, and [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed)\
...
- "HotDQ"
- "WDMM"
"image": "4-Resources/Compendium/bestiary/beast/token/swarm-of-centipedes.png"
```
^statblock
