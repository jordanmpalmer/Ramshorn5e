...
- "desc": "While out of water, the octopus can hold its breath for 30 minutes."
  "name": "Hold Breath"
- "desc": "The octopus has advantage on Dexterity ([Stealth](4-Resources/Compendium/rules/skills.md#Stealth))\
...
- "desc": "Melee Weapon Attack: dice: d20+4 (+4 to hit), reach 5 ft., one target.\
    \ Hit: 1 bludgeoning damage, and the target is [grappled](4-Resources/Compendium/rules/conditions.md#grappled)\
...
- "IDRotF"
- "WBtW"
"image": "4-Resources/Compendium/bestiary/beast/token/octopus.png"
```
^statblock
