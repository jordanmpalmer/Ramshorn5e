...
- "desc": "Any humanoid that starts its turn within 30 feet of the hag and can see\
    ...
    \ the creature is [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "desc": "Melee Weapon Attack: dice: d20+5 (+5 to hit), reach 5 ft., one target.\
  ...
  "name": "Claws"
- "desc": "The hag targets one [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "JttRC"
- "SatO"
"image": "4-Resources/Compendium/bestiary/fey/token/sea-hag.png"
```
^statblock
...
> 
> 1st level (4 slots): [identify](4-Resources/Compendium/spells/identify.md), [ray of sickness](4-Resources/Compendium/spells/ray-of-sickness.md)  
> 2nd level (3 slots): [hold person](4-Resources/Compendium/spells/hold-person.md), [locate object](4-Resources/Compendium/spells/locate-object.md)  
> 3rd level (3 slots): [bestow curse](4-Resources/Compendium/spells/bestow-curse.md), [counterspell](4-Resources/Compendium/spells/counterspell.md), [lightning bolt](4-Resources/Compendium/spells/lightning-bolt.md)  
> 4th level (3 slots): [phantasmal killer](4-Resources/Compendium/spells/phantasmal-killer.md), [polymorph](4-Resources/Compendium/spells/polymorph.md)  
> 5th level (2 slots): [contact other plane](4-Resources/Compendium/spells/contact-other-plane.md), [scrying](4-Resources/Compendium/spells/scrying.md)  
> 6th level (1 slot): [eyebite](4-Resources/Compendium/spells/eyebite.md)  
> 
> For casting these spells, each hag is a 12th-level spellcaster that uses Intelligence as her spellcasting ability. The spell save DC is 12 + the hag's Intelligence modifier, and the spell attack bonus is 4 + the hag's Intelligence modifier.
> 
> **Hag Eye.** A hag coven can craft a magic item called a hag eye, which is made from a real eye coated in varnish and often fitted to a pendant or other wearable item. The hag eye is usually entrusted to a minion for safekeeping and transport. A hag in the coven can take an action to see what the hag eye sees if the hag eye is on the same plane of existence. A hag eye has AC 10, 1 hit point, and [darkvision](4-Resources/Compendium/rules/senses.md#darkvision) with a radius of 60 feet. If it is destroyed, each coven member takes `dice: 3d10|avg` (`3d10`) psychic damage and is [blinded](4-Resources/Compendium/rules/conditions.md#blinded) for 24 hours.
> 
> A hag coven can have only one hag eye at a time, and creating a new one requires all three members of the coven to perform a ritual. The ritual takes 1 hour, and the hags can't perform it while [blinded](4-Resources/Compendium/rules/conditions.md#blinded). During the ritual, if the hags take any action other than performing the ritual, they must start over.
^hag-covens
