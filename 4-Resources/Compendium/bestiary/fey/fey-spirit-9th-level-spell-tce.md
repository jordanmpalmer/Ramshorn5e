...
- monster/type/fey
statblock: inline
aliases: ["Fey Spirit (9th-level Spell)"]
---
```statblock
"name": "Fey Spirit (9th-level Spell) (TCE)"
"size": "Small"
"type": "fey"
"alignment": "Unaligned"
"ac": !!int "21"
...
- "desc": "The fey magically teleports up to 30 feet to an unoccupied space it can\
    ...
    \ DC. Unless the save succeeds, the target is [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
...
"source":
- "TCE"
"image": "4-Resources/Compendium/bestiary/fey/token/fey-spirit.png"
```
^statblock
# [Fey Spirit (9th-level Spell)](4-Resources/Compendium/bestiary/fey/fey-spirit-9th-level-spell-tce.md)
