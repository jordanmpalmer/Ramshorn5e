...
- "desc": "The djinni's innate spellcasting ability is Charisma (spell save DC 17,\
    ...
    \ spells, requiring no material components:\n\nAt will: [detect evil and good](4-Resources/Compendium/spells/detect-evil-and-good.md),\
    \ [detect magic](4-Resources/Compendium/spells/detect-magic.md), [thunderwave](4-Resources/Compendium/spells/thunderwave.md)\n\
    ...
    \ only), [creation](4-Resources/Compendium/spells/creation.md), [gaseous form](4-Resources/Compendium/spells/gaseous-form.md),\
    ...
    \ (can create wine instead of water), [tongues](4-Resources/Compendium/spells/tongues.md),\
...
- "desc": "A 5-foot-radius, 30-foot-tall cylinder of swirling air magically forms\
    ...
    \ long as the djinni maintains [concentration](4-Resources/Compendium/rules/conditions.md#concentration)\
    \ (as if concentrating on a spell). Any creature but the djinni that enters the\
    \ whirlwind must succeed on a DC 18 Strength saving throw or be [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
    \ by it. The djinni can move the whirlwind up to 60 feet as an action, and creatures\
    \ [restrained](4-Resources/Compendium/rules/conditions.md#restrained) by the whirlwind\
    \ move with it. The whirlwind ends if the djinni loses sight of it.\n\nA creature\
    \ can use its action to free a creature [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
    \ by the whirlwind, including itself, by succeeding on a DC 18 Strength check.\
    \ If the check succeeds, the creature is no longer [restrained](4-Resources/Compendium/rules/conditions.md#restrained)\
...
- "JttRC"
- "SatO"
"image": "4-Resources/Compendium/bestiary/elemental/token/djinni.png"
```
^statblock
