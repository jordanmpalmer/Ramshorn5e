...
- "desc": "If the galeb duhr rolls at least 20 feet straight toward a target and then\
    ...
    \ on a DC 16 Strength saving throw or be knocked [prone](4-Resources/Compendium/rules/conditions.md#prone)."
  "name": "Rolling Charge"
"actions":
...
- "desc": "The galeb duhr magically animates up to two boulders it can see within\
    ...
    \ has Intelligence 1 and Charisma 1, it can't be [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ or [frightened](4-Resources/Compendium/rules/conditions.md#frightened), and\
    \ it lacks this action option. A boulder remains animated as long as the galeb\
    \ duhr maintains [concentration](4-Resources/Compendium/rules/conditions.md#concentration),\
...
- "KftGV"
- "PaBTSO"
"image": "4-Resources/Compendium/bestiary/elemental/token/galeb-duhr.png"
```
^statblock
