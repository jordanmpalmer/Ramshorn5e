...
"condition_immunities": "[charmed](4-Resources/Compendium/rules/conditions.md#charmed),\
  ...
  \ [restrained](4-Resources/Compendium/rules/conditions.md#restrained), [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious)"
...
- "desc": "Melee Spell Attack: dice: d20+4 (+4 to hit), reach 5 ft., one creature.\
    \ Hit: dice: 3d6|avg (3d6) necrotic damage. The target must succeed on a\
...
- "ToFW"
- "BMT"
"image": "4-Resources/Compendium/bestiary/undead/token/specter.png"
```
^statblock
# [Specter](4-Resources/Compendium/bestiary/undead/specter.md)
*Source: Monster Manual p. 279, Tasha's Cauldron of Everything. Available in the SRD.*  
