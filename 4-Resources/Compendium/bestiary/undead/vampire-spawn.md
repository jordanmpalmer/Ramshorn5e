...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ weapon made of wood is driven into its heart while it is [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated)\
...
- "desc": "Melee Weapon Attack: dice: d20+6 (+6 to hit), reach 5 ft., one willing\
    ...
    \ dice: 1d6 + 3|avg (1d6 + 3) piercing damage plus dice: 2d6|avg (2d6)\
...
- "TCE"
- "AATM"
"image": "4-Resources/Compendium/bestiary/undead/token/vampire-spawn.png"
```
^statblock
# [Vampire Spawn](4-Resources/Compendium/bestiary/undead/vampire-spawn.md)
*Source: Monster Manual p. 298, Tasha's Cauldron of Everything. Available in the SRD.*  
