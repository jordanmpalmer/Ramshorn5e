...
"condition_immunities": "[charmed](4-Resources/Compendium/rules/conditions.md#charmed),\
  ...
  \ [prone](4-Resources/Compendium/rules/conditions.md#prone), [stunned](4-Resources/Compendium/rules/conditions.md#stunned)"
...
- "desc": "The demilich emits a bloodcurdling howl. Each creature within 30 feet of\
    ...
    \ throw or drop to 0 hit points. On a successful save, the creature is [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "desc": "The demilich magically swirls its dusty remains. Each creature within 10\
    ...
    \ saving throw or be [blinded](4-Resources/Compendium/rules/conditions.md#blinded)\
...
- "desc": "Each creature with in 30 feet of the demilich must make a DC 15 Constitution\
    ...
    \ restored with the  [greater restoration](4-Resources/Compendium/spells/greater-restoration.md)\
...
- "JttRC"
- "ToFW"
"image": "4-Resources/Compendium/bestiary/undead/token/demilich.png"
```
^statblock
