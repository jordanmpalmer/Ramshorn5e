...
- "desc": "The vampire is a 9th-level spellcaster. Its spellcasting ability is Intelligence\
    ...
    \ [fog cloud](4-Resources/Compendium/spells/fog-cloud.md), [sleep](4-Resources/Compendium/spells/sleep.md)\n\
    \n2nd level (3 slots): [detect thoughts](4-Resources/Compendium/spells/detect-thoughts.md),\
    \ [gust of wind](4-Resources/Compendium/spells/gust-of-wind.md), [mirror image](4-Resources/Compendium/spells/mirror-image.md)\n\
    \n3rd level (3 slots): [animate dead](4-Resources/Compendium/spells/animate-dead.md),\
    \ [bestow curse](4-Resources/Compendium/spells/bestow-curse.md), [nondetection](4-Resources/Compendium/spells/nondetection.md)\n\
    \n4th level (3 slots): [blight](4-Resources/Compendium/spells/blight.md),\
    \ [greater invisibility](4-Resources/Compendium/spells/greater-invisibility.md)\n\
    \n5th level (1 slots): [dominate person](4-Resources/Compendium/spells/dominate-person.md)"
  "name": "spells"
...
- "desc": "When it drops to 0 hit points outside its resting place, the vampire transforms\
    \ into a cloud of mist (as in the Shapechanger trait) instead of falling [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious),\
    ...
    \ then [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed) until\
...
- "desc": "The vampire has the following flaws:\n\nForbiddance. The vampire can't\
    ...
    \ into the vampire's heart while the vampire is [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated)\
    \ in its resting place, the vampire is [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed)\
...
- "desc": "Melee Weapon Attack: dice: d20+9 (+9 to hit), reach 5 ft., one willing\
    \ creature, or a creature that is [grappled](4-Resources/Compendium/rules/conditions.md#grappled)\
    \ by the vampire, [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated),\
    \ or [restrained](4-Resources/Compendium/rules/conditions.md#restrained). Hit:\
    \ dice: 1d6 + 4|avg (1d6 + 4) piercing damage plus dice: 3d6|avg (3d6)\
    ...
    \ spawn](4-Resources/Compendium/bestiary/undead/vampire-spawn.md) under the vampire's\
    \ control."
...
- "desc": "The vampire targets one humanoid it can see within 30 feet of it. If the\
    ...
    \ throw against this magic or be [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
    \ by the vampire. The [charmed](4-Resources/Compendium/rules/conditions.md#charmed)\
  ...
  "name": "Charm"
- "desc": "The vampire magically calls dice: 2d4|avg (2d4) swarms of [bats](4-Resources/Compendium/bestiary/beast/swarm-of-bats.md)\
    \ or [rats](4-Resources/Compendium/bestiary/beast/swarm-of-rats.md), provided\
    \ that the sun isn't up. While outdoors, the vampire can call dice: 3d6|avg\
    \ (3d6) [wolves](4-Resources/Compendium/bestiary/beast/wolf.md) instead. The\
    \ called creatures arrive in dice: 1d4|avg (1d4) rounds, acting as allies\
    \ of the vampire and obeying its spoken commands. The beasts remain for 1 hour,\
...
- "MM"
- "RoT"
"image": "4-Resources/Compendium/bestiary/undead/token/vampire-spellcaster.png"
```
^statblock
