...
- "desc": "When the revenant's body is destroyed, its soul lingers. After 24 hours,\
    ...
    \ existence and regains all its hit points. While the soul is bodiless, a [wish](4-Resources/Compendium/spells/wish.md)\
...
- "desc": "The revenant targets one creature it can see within 30 feet of it and against\
    ...
    \ On a failure, the target is [paralyzed](4-Resources/Compendium/rules/conditions.md#paralyzed)\
    \ until the revenant deals damage to it, or until the end of the revenant's next\
    \ turn. When the paralysis ends, the target is [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
    \ of the revenant for 1 minute. The [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
    \ target can repeat the saving throw at the end of each of its turns, with disadvantage\
    \ if it can see the revenant, ending the [frightened](4-Resources/Compendium/rules/conditions.md#frightened)\
...
- "SatO"
- "BMT"
"image": "4-Resources/Compendium/bestiary/undead/token/revenant.png"
```
^statblock
