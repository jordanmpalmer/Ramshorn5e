...
|---------------|--------|
| 3rd | [guiding bolt](4-Resources/Compendium/spells/guiding-bolt.md), [heroism](4-Resources/Compendium/spells/heroism.md) |
| 5th | [enhance ability](4-Resources/Compendium/spells/enhance-ability.md), [magic weapon](4-Resources/Compendium/spells/magic-weapon.md) |
...
| 13th | [compulsion](4-Resources/Compendium/spells/compulsion.md), [freedom of movement](4-Resources/Compendium/spells/freedom-of-movement.md) |
...
As a bonus action, you can use your Channel Divinity to augment your athleticism. For the next 10 minutes, you have advantage on Strength ([Athletics](4-Resources/Compendium/rules/skills.md#Athletics)) and Dexterity ([Acrobatics](4-Resources/Compendium/rules/skills.md#Acrobatics)) checks; you can carry, push, drag, and lift twice as much weight as normal; and the distance of your long and high jumps increases by 10 feet (this extra distance costs movement as normal).
...
You emanate an aura that fills you and your companions with supernatural speed, allowing you to race across a battlefield in formation. Your walking speed increases by 10 feet. In addition, if you aren't [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated), the walking speed of any ally who starts their turn within 5 feet of you increases by 10 feet until the end of that turn.
