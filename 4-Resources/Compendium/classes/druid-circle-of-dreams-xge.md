...
While within the sphere, you and your allies gain a +5 bonus to Dexterity ([Stealth](4-Resources/Compendium/rules/skills.md#Stealth)) and Wisdom ([Perception](4-Resources/Compendium/rules/skills.md#Perception)) checks, and any light from open flames in the sphere (a campfire, torches, or the like) isn't visible outside it.
...
When you finish a short rest, you can cast one of the following spells, without expending a spell slot or requiring material components: [dream](4-Resources/Compendium/spells/dream.md) (with you as the messenger), [scrying](4-Resources/Compendium/spells/scrying.md), or [teleportation circle](4-Resources/Compendium/spells/teleportation-circle.md).

This use of [teleportation circle](4-Resources/Compendium/spells/teleportation-circle.md) is special. Rather than opening a portal to a permanent [teleportation circle](4-Resources/Compendium/spells/teleportation-circle.md), it opens a portal to the last location where you finished a long rest on your current plane of existence. If you haven't taken a long rest on your current plane, the spell fails but isn't wasted.
