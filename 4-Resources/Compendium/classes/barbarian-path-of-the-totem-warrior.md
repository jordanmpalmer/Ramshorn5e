...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](4-Resources/Compendium/spells/beast-sense.md) and [speak with animals](4-Resources/Compendium/spells/speak-with-animals.md) spells, but only as rituals, as described in "chapter 10".
...
- **Eagle**  
    ...
    While you're raging and aren't wearing heavy armor, other creatures have disadvantage on opportunity attack rolls against you, and you can use the [Dash](4-Resources/Compendium/rules/actions.md#Dash) action as a bonus action on your turn. The spirit of the eagle makes you into a predator who can weave through the fray with ease.  
...
At 10th level, you can cast the [commune with nature](4-Resources/Compendium/spells/commune-with-nature.md) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
...
- **Bear**  
    ...
    While you're raging, any creature within 5 feet of you that's hostile to you has disadvantage on attack rolls against targets other than you or another character with this feature. An enemy is immune to this effect if it can't see or hear you or if it can't be [frightened](4-Resources/Compendium/rules/conditions.md#frightened).  
...
- **Wolf**  
    ...
    While you're raging, you can use a bonus action on your turn to knock a Large or smaller creature [prone](4-Resources/Compendium/rules/conditions.md#prone) when you hit it with melee weapon attack.