...
- **Armor**: light, medium, [shields](4-Resources/Compendium/items/shield.md)
...
- (a) [scale mail](4-Resources/Compendium/items/scale-mail.md) or (b) [leather armor](4-Resources/Compendium/items/leather-armor.md)  
- (a) two [shortswords](4-Resources/Compendium/items/shortsword.md) or (b) two simple melee weapons  
...
- A [longbow](4-Resources/Compendium/items/longbow.md) and a [quiver](4-Resources/Compendium/items/quiver.md) of [20 arrows](4-Resources/Compendium/items/arrows-20.md)  
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](4-Resources/Compendium/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](4-Resources/Compendium/bestiary/humanoid/gnoll.md) and [orcs](4-Resources/Compendium/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](4-Resources/Compendium/rules/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
*1st-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature*

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](4-Resources/Compendium/rules/conditions.md#concentration) (as if you were concentrating on a spell).
...
*1st-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md), which replaces the Natural Explorer feature*
...
- [Archery](4-Resources/Compendium/optional-features/archery.md)  
- [Defense](4-Resources/Compendium/optional-features/defense.md)  
...
For example, if you know the 1st-level spell [animal friendship](4-Resources/Compendium/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](4-Resources/Compendium/spells/animal-friendship.md) using either slot.
...
*2nd-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*

You can use a [druidic focus](4-Resources/Compendium/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
*3rd-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md), which replaces the Primeval Awareness feature*
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](4-Resources/Compendium/spells/speak-with-animals.md) |
| 5th | [beast sense](4-Resources/Compendium/spells/beast-sense.md) |
| 9th | [speak with plants](4-Resources/Compendium/spells/speak-with-plants.md) |
| 13th | [locate creature](4-Resources/Compendium/spells/locate-creature.md) |
| 17th | [commune with nature](4-Resources/Compendium/spells/commune-with-nature.md) |
^primal-awareness-spells
...
*4th-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a fighting style you know with another fighting style available to rangers. This replacement represents a shift of focus in your martial practice.

### Extra Attack (Level 5)

Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](4-Resources/Compendium/rules/actions.md#Attack) action on your turn.
...
Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](4-Resources/Compendium/rules/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)
_Source: Tasha's Cauldron of Everything p. 56_

*10th-level ranger [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md), which replaces the Hide in Plain Sight feature*

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](4-Resources/Compendium/rules/conditions.md#invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](4-Resources/Compendium/rules/conditions.md#exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](4-Resources/Compendium/rules/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
At 18th level, you gain preternatural senses that help you fight creatures you can't see. When you attack a creature you can't see, your inability to see it doesn't impose disadvantage on your attack rolls against it. You are also aware of the location of any [invisible](4-Resources/Compendium/rules/conditions.md#invisible) creature within 30 feet of you, provided that the creature isn't hidden from you and you aren't [blinded](4-Resources/Compendium/rules/conditions.md#blinded) or [deafened](4-Resources/Compendium/rules/conditions.md#deafened).
...
> ![Fighting Style, Ranger](4-Resources/Compendium/optional-features/list-fighting-style-ranger.md#Fighting%20Style,%20Ranger)
