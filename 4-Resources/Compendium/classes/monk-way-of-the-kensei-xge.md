...
- **Agile Parry**  
    ...
    If you make an unarmed strike as part of the [Attack](4-Resources/Compendium/rules/actions.md#Attack) action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren't [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated).  
...
You gain proficiency with your choice of [calligrapher's supplies](4-Resources/Compendium/items/calligraphers-supplies.md) or [painter's supplies](4-Resources/Compendium/items/painters-supplies.md).
