...
- **Tools**: three [musical instruments](4-Resources/Compendium/items/musical-instrument.md) of your choice
...
- (a) a [rapier](4-Resources/Compendium/items/rapier.md), (b) a [longsword](4-Resources/Compendium/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](4-Resources/Compendium/items/diplomats-pack.md) or (b) an [entertainer's pack](4-Resources/Compendium/items/entertainers-pack.md)  
- (a) a [lute](4-Resources/Compendium/items/lute.md) or (b) any other musical instrument  
- [Leather armor](4-Resources/Compendium/items/leather-armor.md), and a [dagger](4-Resources/Compendium/items/dagger.md)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: one [musical instrument](4-Resources/Compendium/items/musical-instrument.md) of your choice
...
You can make a bard quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Dexterity. Second, choose the [entertainer](4-Resources/Compendium/backgrounds/entertainer.md) background. Third, choose the [dancing lights](4-Resources/Compendium/spells/dancing-lights.md) and [vicious mockery](4-Resources/Compendium/spells/vicious-mockery.md) cantrips, along with the following 1st-level spells: [charm person](4-Resources/Compendium/spells/charm-person.md), [detect magic](4-Resources/Compendium/spells/detect-magic.md), [healing word](4-Resources/Compendium/spells/healing-word.md), and [thunderwave](4-Resources/Compendium/spells/thunderwave.md).
...
| 2 | A mithral [horn](4-Resources/Compendium/items/horn.md) made by elves |
| 3 | A zither made with drow spider silk |
| 4 | An orcish [drum](4-Resources/Compendium/items/drum.md) |
...
| 6 | When you sat on your [lute](4-Resources/Compendium/items/lute.md) by mistake during the final stanza of "Starlight Serenade" |
^embarrassment
...
For example, if you know the 1st-level spell [cure wounds](4-Resources/Compendium/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](4-Resources/Compendium/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](4-Resources/Compendium/items/musical-instrument.md) as a spellcasting focus for your bard spells.
...
*2nd-level bard [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level bard [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
At 6th level, you gain the ability to use musical notes or words of power to disrupt mind-influencing effects. As an action, you can start a performance that lasts until the end of your next turn. During that time, you and any friendly creatures within 30 feet of you have advantage on saving throws against being [frightened](4-Resources/Compendium/rules/conditions.md#frightened) or [charmed](4-Resources/Compendium/rules/conditions.md#charmed). A creature must be able to hear you to gain this benefit. The performance ends early if you are [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated) or silenced or if you voluntarily end it (no action required).
