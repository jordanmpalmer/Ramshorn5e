...
- (a) a [mace](4-Resources/Compendium/items/mace.md) or (b) a [warhammer](4-Resources/Compendium/items/warhammer.md) (if proficient)  
- (a) [scale mail](4-Resources/Compendium/items/scale-mail.md), (b) [leather armor](4-Resources/Compendium/items/leather-armor.md), or (c) [chain mail](4-Resources/Compendium/items/chain-mail.md) (if proficient)  
...
- A [shield](4-Resources/Compendium/items/shield.md) and a [holy symbol](4-Resources/Compendium/items/holy-symbol.md)  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](4-Resources/Compendium/backgrounds/acolyte.md) background.
...
You can use a [holy symbol](4-Resources/Compendium/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
...
*2nd-level cleric [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
*4th-level cleric [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
