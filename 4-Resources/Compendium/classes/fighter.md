...
- (a) [chain mail](4-Resources/Compendium/items/chain-mail.md) or (b) [leather armor](4-Resources/Compendium/items/leather-armor.md), [longbow](4-Resources/Compendium/items/longbow.md), and [20 arrows](4-Resources/Compendium/items/arrows-20.md)  
- (a) a martial weapon and a [shield](4-Resources/Compendium/items/shield.md) or (b) two martial weapons  
- (a) a [light crossbow](4-Resources/Compendium/items/light-crossbow.md) and [20 bolts](4-Resources/Compendium/items/crossbow-bolts-20.md) or (b) two [handaxes](4-Resources/Compendium/items/handaxe.md)  
...
You can make a fighter quickly by following these suggestions. First, make Strength or Dexterity your highest ability score, depending on whether you want to focus on melee weapons or on archery (or finesse weapons). Your next-highest score should be Constitution, or Intelligence if you plan to adopt the Eldritch Knight martial archetype. Second, choose the [soldier](4-Resources/Compendium/backgrounds/soldier.md) background.
...
*4th-level fighter [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can do one of the following, as you shift the focus of your martial practice:

- Replace a [fighting style](4-Resources/Compendium/optional-features/list-fighting-style-fighter.md) you know with another fighting style available to fighters.  
- If you know any [maneuvers](4-Resources/Compendium/optional-features/list-maneuver-battle-master.md) from the [Battle Master](4-Resources/Compendium/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
At 11th level, you can attack three times whenever you take the [Attack](4-Resources/Compendium/rules/actions.md#Attack) action on your turn.
...
At 20th level, you can attack four times whenever you take the [Attack](4-Resources/Compendium/rules/actions.md#Attack) action on your turn.

## Optional Features

> [!example]- Fighting Style, Fighter
> ![Fighting Style, Fighter](4-Resources/Compendium/optional-features/list-fighting-style-fighter.md#Fighting%20Style,%20Fighter)
