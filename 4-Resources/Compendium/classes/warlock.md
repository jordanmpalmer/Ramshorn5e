...
> 
> | Level | Cantrips Known | Spells Known | Spell Slots | Slot Level | [Invocations Known](4-Resources/Compendium/optional-features/list-eldritch-invocation.md) |
> |-------|----------------|--------------|-------------|------------|-------------------------------------------------------------------------------------------|
> | 1st | 2 | 2 | 1 | 1st | ⏤ |
> | 2nd | 2 | 3 | 2 | 1st | 2 |
> | 3rd | 2 | 4 | 2 | 2nd | 2 |
...
- (a) a [scholar's pack](4-Resources/Compendium/items/scholars-pack.md) or (b) a [dungeoneer's pack](4-Resources/Compendium/items/dungeoneers-pack.md)  
- [Leather armor](4-Resources/Compendium/items/leather-armor.md), any simple weapon, and two [daggers](4-Resources/Compendium/items/dagger.md)  
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](4-Resources/Compendium/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](4-Resources/Compendium/spells/eldritch-blast.md) and [chill touch](4-Resources/Compendium/spells/chill-touch.md) cantrips, along with the 1st-level spells [charm person](4-Resources/Compendium/spells/charm-person.md) and [witch bolt](4-Resources/Compendium/spells/witch-bolt.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](4-Resources/Compendium/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](4-Resources/Compendium/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](4-Resources/Compendium/optional-features/list-eldritch-invocation.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
*4th-level warlock [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
> ![Eldritch Invocation](4-Resources/Compendium/optional-features/list-eldritch-invocation.md#Eldritch%20Invocation)
^list-eldritch-invocation

> [!example]- Pact Boon
> ![Pact Boon](4-Resources/Compendium/optional-features/list-pact-boon.md#Pact%20Boon)
^list-pact-boon