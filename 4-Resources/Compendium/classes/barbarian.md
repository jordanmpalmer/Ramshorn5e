...
- (a) a [greataxe](4-Resources/Compendium/items/greataxe.md) or (b) any martial melee weapon  
- (a) two [handaxes](4-Resources/Compendium/items/handaxe.md) or (b) any simple weapon  
- An [explorer's pack](4-Resources/Compendium/items/explorers-pack.md), and four [javelins](4-Resources/Compendium/items/javelin.md)  
...
- **Armor**: [shields](4-Resources/Compendium/items/shield.md)
- **Weapons**: simple, martial
- **Tools**: none
...
You can make a barbarian quickly by following these suggestions. First, put your highest ability score in Strength, followed by Constitution. Second, choose the [outlander](4-Resources/Compendium/backgrounds/outlander.md) background.
...
Your rage lasts for 1 minute. It ends early if you are knocked [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious) or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action.
...
At 2nd level, you gain an uncanny sense of when things nearby aren't as they should be, giving you an edge when you dodge away from danger. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. To gain this benefit, you can't be [blinded](4-Resources/Compendium/rules/conditions.md#blinded), [deafened](4-Resources/Compendium/rules/conditions.md#deafened), or [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated).
...
*3rd-level barbarian [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
Additionally, if you are surprised at the beginning of combat and aren't [incapacitated](4-Resources/Compendium/rules/conditions.md#incapacitated), you can act normally on your first turn, but only if you enter your rage before doing anything else on that turn.

### Instinctive Pounce (Level 7)
_Source: Tasha's Cauldron of Everything p. 24_

*7th-level barbarian [optional class features](4-Resources/Compendium/rules/variant-rules/optional-class-features-tce.md)*
...
Beginning at 15th level, your rage is so fierce that it ends early only if you fall [unconscious](4-Resources/Compendium/rules/conditions.md#unconscious) or if you choose to end it.
