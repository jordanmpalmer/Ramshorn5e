...
A creature that can see the sensor (such as one using [see invisibility](4-Resources/Compendium/spells/see-invisibility.md) or [truesight](4-Resources/Compendium/rules/senses.md#truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
