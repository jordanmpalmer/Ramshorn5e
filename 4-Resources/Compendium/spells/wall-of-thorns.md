...
When the wall appears, each creature within its area must make a Dexterity saving throw. On a failed save, a creature takes `dice: 7d8|avg` (`7d8`) piercing damage, or half as much damage on a successful save.
