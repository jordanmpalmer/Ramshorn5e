...
- When you are [prone](Conditions#Prone), standing up uses only 5 feet of your movement.
...
If you move at least 10 feet in a straight line immediately before taking this bonus action, you either gain a +5 bonus to the attack’s damage roll (if you chose to make a melee attack and hit) or push the target up to 10 feet away from you (if you chose to [shove](<Combat#Shoving a Creature>) and you succeed).
...
- You can use your action to try to pin a creature [grappled](Conditions#Grappled) by you. To do so, make another [grapple](Combat#Grappling) check. If you succeed, you and the creature are both [restrained](Conditions#Restrained) until the grapple ends.
...
- You learn two maneuvers of your choice from among those available to the [Battle Master archetype](<Battle Master>) in the fighter class. If a maneuver you use requires your target to make a saving throw to resist the maneuver’s effects, the saving throw DC equals 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice).
...
You are a dangerous foe to face while mounted. While you are mounted and aren’t [incapacitated](Conditions#Incapacitated), you gain the following benefits:
...
- If you aren’t [incapacitated](Conditions#^Incapacitated), you can add your shield’s [AC](<Abilities#Armor Class>) bonus to any Dexterity saving throw you make against a spell or other harmful effect that targets only you.
