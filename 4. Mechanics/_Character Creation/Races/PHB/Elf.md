...
_**Fey Ancestry.**_ You have [[Advantage and Disadvantage|advantage]] on [[saving throws]] against being [[4. Mechanics/_Gameplay/ConditionsRef/Charmed]], and magic can’t put you to sleep.
...
_**Mask of the Wild.**_ You can attempt to [[Hide|hide]] even when you are only [[Vision and Light|lightly obscured]] by foliage, heavy rain, falling snow, mist, and other natural phenomena.
...
_**Sunlight Sensitivity.**_ You have [[Advantage and Disadvantage|disadvantage]] on attack rolls and on Wisdom ([[Perception]] checks that rely on sight when you, the target of your attack, or whatever you are trying to perceive is in direct sunlight.
