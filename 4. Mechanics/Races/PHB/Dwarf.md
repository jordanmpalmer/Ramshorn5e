...
_**Dwarven Resilience.**_ You have [[Abilities#Advantage and Disadvantage|advantage]] on saving throws against poison, and you have resistance against poison damage (explained in chapter 9, “[[Combat]]”).
...
_**Stonecunning.**_ Whenever you make an Intelligence ([[Abilities#^history|History]]) check related to the origin of stonework, you are considered proficient in the [[Abilities#^history|History]] skill and add double your proficiency bonus to the check, instead of your normal proficiency bonus
...
>DUERGAR
>
>In cities deep in the Underdark live the duergar, or gray dwarves. After centuries of captivity and torment by mind flayers, they have innate magical abilities to become [[Conditions#Invisible|invisible]] and to temporarily grow to giant size.
