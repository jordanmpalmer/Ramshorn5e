...
**_Medicine._** A Wisdom ([Medicine](https://www.dndbeyond.com/compendium/rules/basic-rules/using-ability-scores#Medicine)) check lets you try to stabilize a dying companion or diagnose an illness. ^medicine
