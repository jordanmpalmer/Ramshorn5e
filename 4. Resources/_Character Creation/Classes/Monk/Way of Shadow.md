...
Starting when you choose this tradition at 3rd level, you can use your ki to duplicate the effects of certain spells. As an action, you can spend 2 ki points to cast [darkness](Darkness.md), [darkvision](4.%20Resources/Spells/SRD/Darkvision.md), [pass without trace](Pass%20without%20Trace.md without Trace>), or [silence](Silence.md), without providing material components. Additionally, you gain the [minor illusion](Minor%20Illusion.md Illusion>) cantrip if you don’t already know it.

#### Shadow Step

At 6th level, you gain the ability to step from one shadow into another. When you are in dim light or darkness, as a bonus action you can teleport up to 60 feet to an unoccupied space you can see that is also in dim light or darkness. You then have [advantage](Abilities.md#Advantage%20and%20Disadvantage and Disadvantage>) on the first melee attack you make before the end of the turn.
